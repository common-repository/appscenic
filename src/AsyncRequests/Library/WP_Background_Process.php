...
namespace AppScenic\AsyncRequests\Library;
...
abstract class WP_Background_Process extends WP_Async_Request {
	...
	public function schedule_cron_healthcheck( $schedules ) {
		...
		if ( 1 === $interval ) {
			$display = esc_html__( 'Every Minute', 'appscenic' );
		} else {
			$display = sprintf( esc_html__( 'Every %d Minutes', 'appscenic' ), esc_html__( $interval ) );
		}
